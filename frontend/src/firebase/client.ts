...
export const firebaseEnabled=import.meta.env.VITE_USE_FIREBASE==='true' && Boolean(cfg.apiKey&&cfg.projectId);
const app=firebaseEnabled?(getApps()[0]??initializeApp(cfg)):null;
